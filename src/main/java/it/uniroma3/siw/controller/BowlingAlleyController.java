...
public class BowlingAlleyController {
	...
	@Autowired 
	private ReservationRepository artistRepository;

	@Autowired 
	private BowlingAlleyValidator movieValidator;
	...
	public String setDirectorToMovie(@PathVariable("directorId") Long directorId, @PathVariable("movieId") Long movieId, Model model) {
		...
		Reservation director = this.artistRepository.findById(directorId).get();
		BowlingAlley movie = this.movieRepository.findById(movieId).get();
	...
	public String addActorToMovie(@PathVariable("actorId") Long actorId, @PathVariable("movieId") Long movieId, Model model) {
		BowlingAlley movie = this.movieRepository.findById(movieId).get();
		Reservation actor = this.artistRepository.findById(actorId).get();
	...
	private List<Reservation> actorsToAdd(Long movieId) {
		...
		for (Reservation a : artistRepository.findActorsNotInMovie(movieId)) {
			actorsToAdd.add(a);
		}
		return actorsToAdd;
	}
